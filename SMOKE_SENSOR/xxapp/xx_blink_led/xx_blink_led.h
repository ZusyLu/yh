...
#define XX_BLINK_LED_BSP_LED0_PIN                          (0U)
#define XX_BLINK_LED_BSP_LED0_PORT                         (gpioPortB)
#define XX_BLINK_LED_BSP_LED0                               0

#define XX_BLINK_LED_BSP_LED1_PIN                          (1U)
#define XX_BLINK_LED_BSP_LED1_PORT                         (gpioPortD)
...
#define XX_BLINK_LED_BSP_LED_COUNT                         (0U)
...
#define XX_BLINK_LED_HAL_LED_COUNT                         (0U)
#define XX_BLINK_LED_HAL_LED_ENABLE                        {0} // { 0, 1 , 2 , 3 , 4 }
