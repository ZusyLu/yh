...
#define xxIasMotionSensorPrintString                                                         "XX_IAS_SMOKE_SENSOR:"
...
static void xxIasMotionSendorWriteAndReadVersion( void )
{
    ...
    emberProcessCommandString((uint8_t*)"write 1 0 0x4000 1 0x42 \"1.0.3\"", strlen("write 1 0 0x4000 1 0x42 \"1.0.3\""));
    emberProcessCommandString((uint8_t*)"\n", strlen("\n"));
    xxIasMotionSensorPrintln("\r\n xx Ias smoke Sensor version:");
...
#ifdef XX_SERIAL_SMOKE_RX_WAKE_UP
	XX_SERIAL_SMOKE_RX_WAKE_UP;
#endif
...
void xxProjectScanNetworkFuction( void )
{
    ...
    {
    	#ifdef XX_SERIAL_SMOKE_SCAN_NWK_TIME_OUT
			uint8 value;
			value=2;
...
{   
	...
	#ifdef XX_SERIAL_SMOKE_DATA_NO_SLEEP
		XX_SERIAL_SMOKE_DATA_NO_SLEEP;
	#endif
...
void xxRebootEventHandler( void )
{
   ...
   // XxIasZoneResetUpdateTamperPinFunction();
	...
	xxIasMotionSensorPrintln("xx this is smoke sensor v1.0.3");
