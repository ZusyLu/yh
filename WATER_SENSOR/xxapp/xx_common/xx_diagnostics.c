...
*                                               宏定义
***************************************************************************************************/
#define xxDiagnosticsPrint                                   emberAfAppPrint
#define xxDiagnosticsPrintln                                 emberAfAppPrintln
...
tokTypeStackBootCounter XxDiagnosticsGetResetCunt( void )
{
    tokTypeStackBootCounter rebootCounter;
    halCommonGetToken(&rebootCounter, TOKEN_STACK_BOOT_COUNTER);
    xxDiagnosticsPrintln(" xx reset cunt is = %ld", rebootCounter );
    return rebootCounter;
}

void XxDiagnosticsClearResetCunt( void )
{
    tokTypeStackBootCounter rebootCounter;
    halCommonSetToken( TOKEN_STACK_BOOT_COUNTER, &rebootCounter );
    halCommonGetToken( &rebootCounter, TOKEN_STACK_BOOT_COUNTER );
    xxDiagnosticsPrintln( " xx reset cunt is = %ld", rebootCounter );
}
