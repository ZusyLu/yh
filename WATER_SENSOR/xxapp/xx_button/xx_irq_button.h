...
#define XX_IRQ_BSP_BUTTON0_PIN                             (1U)
#define XX_IRQ_BSP_BUTTON0_PORT                            (gpioPortB)
#define XX_IRQ_BSP_BUTTON0                                 (0U)

    
#define XX_IRQ_BSP_BUTTON1_PIN                             (3U)
#define XX_IRQ_BSP_BUTTON1_PORT                            (gpioPortA)
...
#define XX_IRQ_BUTTON_COUNT                                (2U)
#define XX_IRQ_BSP_BUTTON_CUNT                             (2U)
...
#define XX_IRQ_BSP_BUTTON_GPIO_MODE                        (HAL_GPIO_MODE_INPUT)

#define XX_IRQ_BUTTON_ENABLE                               { 0, 1 }//{ 0, 1, 2 }
