...
/** @brief <b>zcl lock toggle [pin:-1] </b>
 *   - <i>Toggles the door lock from its current state to the opposite state locked or unlocked.</i>
 *     - pin - CHAR_STRING
 */
...
/** @brief <b>zcl lock clear-all-pins </b>
 *   - <i>Clear all PIN codes on the lock for all users.</i>
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_DOOR_LOCK_CLEAR_ALL_PINS

/** @brief <b>zcl lock set-user-status [userId:2] [userStatus:1] </b>
 *   - <i>Set the status value for a specified user ID.</i>
 *     - userId - INT16U
 *     - userStatus - INT8U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_DOOR_LOCK_SET_USER_STATUS

/** @brief <b>zcl lock get-user-status [userId:2] </b>
 *   - <i>Retrieve the status byte for a specific user.</i>
 *     - userId - INT16U
 */
...
/** @brief <b>zcl lock set-disposable-schedule [userId:2] [localStartTime:4] [localEndTime:4] </b>
 *   - <i>Set the Disposable Schedule by specifying local start time and local end time for the specific user.</i>
 *     - userId - INT16U
 *     - localStartTime - INT32U
 *     - localEndTime - INT32U
 */
...
/** @brief <b>zcl lock get-disposable-schedule [userId:2] </b>
 *   - <i>Retrieve the disposable schedule for the specific user.</i>
 *     - userId - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_DOOR_LOCK_GET_DISPOSABLE_SCHEDULE

/** @brief <b>zcl lock clear-disposable-schedule [userId:2] </b>
 *   - <i>Clear the Disposable schedule for the specific user</i>
 *     - userId - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_DOOR_LOCK_CLEAR_DISPOSABLE_SCHEDULE

/** @brief <b>zcl lock clear-biometric-credential [userId:2] </b>
 *   - <i>Clear the Biometric Credential for the specific user</i>
 *     - userId - INT16U
 */
#define EMBER_AF_DOXYGEN_CLI_COMMAND_DOOR_LOCK_CLEAR_BIOMETRIC_CREDENTIAL

/** @brief <b>zcl lock clear-all-biometric-credentials </b>
 *   - <i>Clear out all Biometric Credentials on the lock</i>
 */
